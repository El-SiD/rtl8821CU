...
CONFIG_RTW_CFGVEDNOR_RSSIMONITOR = y
CONFIG_RTW_CFGVENDOR_RANDOM_MAC_OUI = y
CONFIG_VHT_EXTRAS = y
CONFIG_XMIT_ACK = y
...
ifeq ($(CONFIG_RTW_CFGVENDOR_RANDOM_MAC_OUI), y)
EXTRA_CFLAGS += -DCONFIG_RTW_CFGVENDOR_RANDOM_MAC_OUI
endif
ifeq ($(CONFIG_RTW_CFGVEDNOR_RSSIMONITOR), y)
...
ifeq ($(CONFIG_XMIT_ACK), y)
EXTRA_CFLAGS += -DCONFIG_XMIT_ACK
endif
